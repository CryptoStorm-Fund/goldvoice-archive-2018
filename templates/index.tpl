...
<div class="content-wrapper-inside-right-revert"></div>
	<div class="content-wrapper">
		...
		<div class="search-box"><input type="text" class="search-textbox" value="{l10n_global_search}" onfocus="if('{l10n_global_search}'==this.value){this.value='';}" onblur="if(''==this.value){this.value='{l10n_global_search}';}"></div>
...
<div class="user-card-dropdown">
	<div class="user-card-dropdown-arrow"></div>
	<div class="confirmation-text"></div>
	<a class="button user-card-refuse"><i class="fa fa-fw fa-times" aria-hidden="true"></i> {l10n_user_card_refuse}</a>
	<a class="button user-card-confirm"><i class="fa fa-fw fa-check" aria-hidden="true"></i> {l10n_user_card_confirm}</a>
</div>
<div class="vote-card-dropdown">
	<div class="vote-card-dropdown-arrow"></div>
	<div class="confirmation-text"></div>
	<div class="fix-percent">
<div class="fix-percent-10 active" data-percent="10"></div><div class="fix-percent-10 active" data-percent="20"></div><div class="fix-percent-10 active" data-percent="30"></div><div class="fix-percent-10 active" data-percent="40"></div><div class="fix-percent-10 active" data-percent="50"></div><div class="fix-percent-10 active" data-percent="60"></div><div class="fix-percent-10 active" data-percent="70"></div><div class="fix-percent-10 active" data-percent="80"></div><div class="fix-percent-10 active" data-percent="90"></div><div class="fix-percent-10 active" data-percent="100"></div>
		<span>100%</span>
	</div>
	<a class="button vote-card-refuse"><i class="fa fa-fw fa-times" aria-hidden="true"></i> {l10n_upvote_card_refuse}</a>
	<a class="button vote-card-confirm"><i class="fa fa-fw fa-check" aria-hidden="true"></i> {l10n_upvote_card_confirm}</a>
</div>
<div class="repost-card-dropdown">
	<div class="repost-card-dropdown-arrow"></div>
	<div class="confirmation-text"></div>
	<div class="repost-comment">
	<textarea name="repost-comment" placeholder="{l10n_repost_card_add_comment}"></textarea>
	</div>
	<a class="button repost-card-refuse"><i class="fa fa-fw fa-times" aria-hidden="true"></i> {l10n_repost_card_refuse}</a>
	<a class="button repost-card-confirm"><i class="fa fa-fw fa-check" aria-hidden="true"></i> {l10n_repost_card_confirm}</a>
</div>
